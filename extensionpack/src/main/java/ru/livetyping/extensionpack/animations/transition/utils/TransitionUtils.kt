package ru.livetyping.extensionpack.animations.transition.utils
...
import ru.livetyping.extensionpack.animations.transition.interpolators.FAST_OUT_SLOW_IN
import ru.livetyping.extensionpack.animations.transition.onTransitionEnd
...
operator fun TransitionSet.iterator() = object : MutableIterator<Transition> {
    ...
    override fun next() = getTransitionAt(index++) ?: throw IndexOutOfBoundsException()
