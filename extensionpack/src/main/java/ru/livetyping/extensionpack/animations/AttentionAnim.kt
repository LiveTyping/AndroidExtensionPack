...
fun View.attentionShake(): AnimatorSet {
    ...
    val object1: ObjectAnimator = ObjectAnimator.ofFloat(
        this, ANIM_translationX_CONST, 0.toFloat(), 25.toFloat(),
...
fun View.attentionTada(): AnimatorSet {
    ...
    val object1: ObjectAnimator =
        ObjectAnimator.ofFloat(this, ANIM_scaleX_CONST, 1f, 0.9f, 0.9f, 1.1f, 1.1f, 1.1f, 1.1f, 1.1f, 1.1f, 1f)
    val object2: ObjectAnimator =
        ObjectAnimator.ofFloat(this, ANIM_scaleY_CONST, 1f, 0.9f, 0.9f, 1.1f, 1.1f, 1.1f, 1.1f, 1.1f, 1.1f, 1f)
    val object3: ObjectAnimator =
        ObjectAnimator.ofFloat(this, ANIM_rotation_CONST, 0f, -3f, -3f, 3f, -3f, 3f, -3f, 3f, -3f, 0f)
